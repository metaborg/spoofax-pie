...
public final class SpoofaxAstBuilder {
    ...
    public static class Factory {
        ...
        @Inject public Factory(
                SpoofaxElementTypeManager elementTypeManager
        ) {
    ...
    @Inject
    public SpoofaxAstBuilder(SpoofaxElementTypeManager elementTypeManager) {
        this.elementTypeManager = elementTypeManager;
    }
    ...
    public ASTNode build(IElementType root, PsiBuilder builder) {
        ...
        while (!builder.eof()) {
            ...
            IElementType elementType = this.elementTypeManager.getElementType((SpoofaxTokenType)builder.getTokenType());
