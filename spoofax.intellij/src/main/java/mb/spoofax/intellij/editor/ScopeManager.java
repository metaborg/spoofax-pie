...
public final class ScopeManager {
     ...
     * @return The most specific scope name that represents the same style as the scope names in the set;
     * or the default scope name when none was found.
     */
    ...
    private Pair<String, TextAttributesKey[]> createScopeStyle(String prefix, TextAttributesKey style) {
        ...
        return new Pair(prefix, new TextAttributesKey[]{ TextAttributesKey.createTextAttributesKey(createScopeID(prefix), style) } );
    }
