...
public class TigerCompileDirectory implements TaskDef<CommandInput<TigerCompileDirectory.Args>, CommandOutput>,
    CommandDef<TigerCompileDirectory.Args> {
    ...
    @Override public CommandOutput exec(ExecContext context, CommandInput<Args> input) throws Exception {
        ...
        final ResourceMatcher matcher = new AllResourceMatcher(new FileResourceMatcher(),
            new PathResourceMatcher(new ExtensionsPathMatcher("tig")));
