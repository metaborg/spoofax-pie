...
public class TigerShowParsedAst implements TaskDef<TransformInput<TigerShowArgs>, TransformOutput>, TransformDef<TigerShowArgs> {
    ...
    @Override public TransformOutput exec(ExecContext context, TransformInput<TigerShowArgs> input) throws Exception {
        ...
        return new TransformOutput(ListView.of(TransformFeedbacks.openEditorWithText(formatted, "Parsed AST for '" + key + "'", null)));
    }
