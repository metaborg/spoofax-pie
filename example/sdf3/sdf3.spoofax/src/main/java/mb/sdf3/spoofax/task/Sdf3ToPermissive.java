...
@LanguageScope
public class Sdf3ToPermissive implements TaskDef<Supplier<@Nullable IStrategoTerm>, @Nullable IStrategoTerm> {
    private final Provider<StrategoRuntime> strategoRuntimeProvider;
    private final Sdf3DesugarTemplates desugarTemplates;

    @Inject public Sdf3ToPermissive(
    ...
    public @Nullable IStrategoTerm exec(ExecContext context, Supplier<@Nullable IStrategoTerm> astSupplier) throws Exception {
        ...
        return strategoRuntime.invoke("module-to-permissive", ast);
    }
}
