...
public class TimCompileToLLVM implements TaskDef<TimCompileToLLVM.Args, CommandFeedback> {
    public static final class Args implements Serializable {
        ...
        @Override public boolean equals(@Nullable Object o) {
            ...
            TimCompileToLLVM.Args input = (TimCompileToLLVM.Args)o;
    ...
    @Inject
    public TimCompileToLLVM(TimAnalyzeFile analyzeFile, TimGetStrategoRuntimeProvider getStrategoRuntimeProvider) {
        ...
        return context.require(analyzeFile, new TimAnalyzeFile.Input(args.rootDirectory, file)).mapOrElse(
            output -> {
                try {
                    ...
                    final IStrategoTerm result = strategoRuntime.invoke("compile-tim", output.ast);
