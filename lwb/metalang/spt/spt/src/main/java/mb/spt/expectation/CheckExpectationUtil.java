...
public class CheckExpectationUtil {
    public static boolean checkSelections(Stream<Message> messages, Iterable<SelectionReference> selectionReferences, String expected, KeyedMessagesBuilder messagesBuilder, TestCase testCase) {
