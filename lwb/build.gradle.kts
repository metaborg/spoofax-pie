plugins {
    ...
    id("org.metaborg.coronium.bundle") version "0.3.18" apply false
    id("org.metaborg.coronium.feature") version "0.3.18" apply false
    id("org.metaborg.coronium.repository") version "0.3.18" apply false
