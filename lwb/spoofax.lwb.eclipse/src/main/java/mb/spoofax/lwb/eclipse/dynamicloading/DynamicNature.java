...
public class DynamicNature implements IProjectNature {
    public static final String relativeId = "dynamicloading.nature";
    public static final String id = SpoofaxLwbPlugin.id + "." + relativeId;
