 ...
 */
@FunctionalInterface
public interface PredicateStrategy3<CTX, A1, A2, A3, T> extends Strategy3<CTX, A1, A2, A3, T, @Nullable T> {
    @Override
    default @Nullable T evalInternal(TegoEngine engine, CTX ctx, A1 arg1, A2 arg2, A3 arg3, T input) {
