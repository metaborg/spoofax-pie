 ...
 */
@FunctionalInterface
public interface LambdaStrategy2<CTX, A1, A2, T, R> extends Strategy2<CTX, A1, A2, T, R> {
    @Override
    default @Nullable R evalInternal(TegoEngine engine, CTX ctx, A1 arg1, A2 arg2, T input) {
        return engine.eval(apply(arg1, arg2), ctx, input);
    }

    @Override
    Strategy<CTX, T, R> apply(A1 arg1, A2 arg2);
}
