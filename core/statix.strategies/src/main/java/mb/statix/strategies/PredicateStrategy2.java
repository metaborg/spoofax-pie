 ...
 */
@FunctionalInterface
public interface PredicateStrategy2<CTX, A1, A2, T> extends Strategy2<CTX, A1, A2, T, @Nullable T> {
    @Override
    default @Nullable T evalInternal(TegoEngine engine, CTX ctx, A1 arg1, A2 arg2, T input) {
