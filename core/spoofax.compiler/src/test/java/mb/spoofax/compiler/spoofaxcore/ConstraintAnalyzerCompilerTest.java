...
class ConstraintAnalyzerCompilerTest extends TestBase {
    @Test void testCompilerDefaults() throws IOException {
        ...
        final ConstraintAnalyzerCompiler.LanguageProjectInput languageProjectInput = TigerInputs.constraintAnalyzerLanguageProjectInput(shared, languageProject).build();
        ...
        final ConstraintAnalyzerCompiler.AdapterProjectInput adapterProjectInput = TigerInputs.constraintAnalyzerAdapterProjectInput(shared, languageProject, adapterProject).build();
