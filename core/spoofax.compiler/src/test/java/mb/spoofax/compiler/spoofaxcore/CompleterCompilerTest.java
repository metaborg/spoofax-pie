...
class CompleterCompilerTest extends TestBase {
    ...
    @Test void testCompilerDefaults() throws IOException {
        ...
        final CompleterCompiler.LanguageProjectInput languageProjectInput = TigerInputs.completerLanguageProjectInput(shared, languageProject).build();
        ...
        final CompleterCompiler.AdapterProjectInput adapterProjectInput = TigerInputs.completerAdapterProjectInput(shared, languageProject, adapterProject).build();
