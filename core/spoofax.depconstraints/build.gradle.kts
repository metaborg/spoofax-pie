...
dependencies {
  constraints {
    ...
    api("org.metaborg.devenv:org.strategoxt.strj:$spoofax2RefretVersion")
    api("org.metaborg.devenv:org.spoofax.terms:$spoofax2RefretVersion")
    api("org.metaborg.devenv:org.spoofax.interpreter.core:$spoofax2RefretVersion")
    api("org.metaborg.devenv:org.spoofax.jsglr:$spoofax2RefretVersion")
    api("org.metaborg.devenv:org.spoofax.jsglr2:$spoofax2RefretVersion")
    api("org.metaborg.devenv:sdf2table:$spoofax2RefretVersion")
    api("org.metaborg.devenv:sdf2parenthesize:$spoofax2RefretVersion")
    api("org.metaborg.devenv:org.metaborg.parsetable:$spoofax2RefretVersion")

    api("org.metaborg.devenv:stratego.build:$spoofax2RefretVersion")
