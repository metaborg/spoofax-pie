...
public abstract class SpoofaxFileEditorProvider implements FileEditorProvider, DumbAware {
    ...
    private final SpoofaxFileManager spoofaxFileManager;

    public SpoofaxFileEditorProvider(SpoofaxEditor.Factory spoofaxEditorFactory, SpoofaxFileManager spoofaxFileManager) {
