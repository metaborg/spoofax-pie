    ...
    @Override public IContributionItem[] getContributionItems() {
        ...
        for(MenuItem menuItem : getMenuItems(languageInstance)) {
            EclipseMenuItemVisitor.run(langMenu, menuItem, (menu, commandAction) -> {
                ...
                menu.add(createCommand(runCommandCommandId, languageComponent.getLanguageInstance().getCoordinate(), commandRequest, finalContext, commandAction.displayName(), commandAction.description()));
            });
        }
