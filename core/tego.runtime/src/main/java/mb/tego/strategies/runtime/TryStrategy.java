 ...
 */
public final class TryStrategy<T> extends NamedStrategy1<Strategy<T, Seq<T>>, T, Seq<T>> {
    ...
    @Override
    public @Nullable Seq<T> evalInternal(TegoEngine engine, Strategy<T, Seq<T>> s, T input) {
