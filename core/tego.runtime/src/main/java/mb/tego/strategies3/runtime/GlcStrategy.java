 ...
 */
public final class GlcStrategy<T, U, R> extends NamedStrategy3<Strategy<T, U>, Strategy<U, R>, Strategy<T, R>, T, R> {
    ...
    public static <T, U, R> Seq<R> eval(TegoEngine engine, Strategy<T, U> condition, Strategy<U, R> onSuccess, Strategy<T, R> onFailure, T input) {
            ...
            private void computeNextCoroutine() throws InterruptedException {
                ...
                if (conditionSeq.next()) {
                    ...
                    do {
                        ...
                        final Seq<R> onSuccessSeq = engine.eval(onSuccess, current);
                        // 3:
    ...
    @Override
    public Seq<R> evalInternal(TegoEngine engine, Strategy<T, U> condition, Strategy<U, R> onSuccess, Strategy<T, R> onFailure, T input) {
