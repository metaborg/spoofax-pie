...
public interface PathSrv extends AutoCloseable {
     ...
     *
     * @param uri URI as a string to resolve.
     ...
     *
     * @param uri Java URI object to resolve.
     * @return Path for given URI.
     */
     ...
     *
     * @param path Java path to resolve.
     ...
     *
     * @param path Path as a string to resolve.
     * @return Path for given URI.
     */
     ...
     *
     * @param file Local file to resolve.
     ...
     *
     * @param path Path to get a local file for.
     * @return Local file.
     * @throws PipeRunEx When given path does not exist.
     */
     ...
     *
     * @param path Path to get a local file for.
     * @param dir  Directory to copy the resources to if they are not on a local filesystem. Must be on the local
     *             filesystem.
     * @return Local file.
     * @throws PipeRunEx When given path does not exist, or when dir is not on the local filesystem.
     */
