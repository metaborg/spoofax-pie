...
public class Esv extends ABuilder<Esv.Input, Esv.Output> {
    public static class Input extends AInput {
        ...
        public final IResource langSpecUri;
        public final IResource esvLangUri;
        public final IResource esvSpecUri;

        public Input(File depDir, IResource langSpecUri, IResource esvLangUri, IResource esvSpecUri) {
            super(depDir);
    ...
    public static class Output implements build.pluto.output.Output {
        ...
        public final @Nullable IResource writtenFileUri;

        public Output(@Nullable IStrategoTerm term, @Nullable IResource writtenFileUri) {
            this.term = term;
