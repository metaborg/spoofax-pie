...
public class StrategoUtils {
    public static String toString(IStrategoTerm term) {
        if(term instanceof IStrategoString) {
            ...
            final IStrategoString pp = prettyPrintTerm(term);
            if(pp != null) {
    ...
    public static IStrategoString prettyPrintTerm(IStrategoTerm term) {
        return prettyPrintTerm(term, 120);
    }

    public static IStrategoString prettyPrintTerm(IStrategoTerm term, int maxWidth) {
