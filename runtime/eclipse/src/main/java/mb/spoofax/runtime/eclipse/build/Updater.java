...
public class Updater {
    ...
    public void updateStyleAsync(SpoofaxEditor editor, String text, Styling styling, @Nullable IProgressMonitor monitor) {
    ...
    public void removeStyleAsync(SpoofaxEditor editor, int textLength, @Nullable IProgressMonitor monitor) {
    ...
    private void updatePresentationAsync(SpoofaxEditor editor, TextPresentation textPresentation, @Nullable String text,
